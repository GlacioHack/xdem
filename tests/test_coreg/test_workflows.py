...
def test_create_inlier_mask(load_examples) -> None:
    """Test that the create_inlier_mask function works expectedly."""

    ref, tba, outlines, _, _ = load_examples  # Load example reference, to-be-aligned and outlines
...
def test_dem_coregistration(load_examples) -> None:
    """
    ...
    ref_dem, tba_dem, outlines, _, _ = load_examples
