...
class TestTerrainAttribute:
    ...
    def test_get_terrain_attribute__out_dtype(self):
        ...
        slope, tpi = xdem.terrain.get_terrain_attribute(self.dem, attribute=["slope", "topographic_position_index"], out_dtype=out_dtype)
