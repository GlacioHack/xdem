...
def test_invalid_vcrs(get_topo_inputs_config, pipeline_topo, wrong_vcrs):
    """
    Test invalid crs
    """
    info_conf = get_topo_inputs_config
    ...
    with pytest.raises(ValueError, match="See: https://xdem.readthedocs.io/en/stable/vertical_ref.html"):
        _ = schemas.validate_configuration(info_conf, schemas.TOPO_SUMMARY_SCHEMA)
