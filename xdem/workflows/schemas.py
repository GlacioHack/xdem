...
class PathValidator(Validator):  # type: ignore
    def _validate_path_exists(self, path_exists: bool, field: str, value: str) -> None:
        """
...
COMPARE_SCHEMA = {
    "inputs": {
        ...
        "required": True,
        "schema": {
            "reference_elev": {"type": "dict", "schema": INPUTS_DEM},
            "to_be_aligned_elev": {"type": "dict", "schema": INPUTS_DEM},
        },
    },
    "outputs": {
        "type": "dict",
