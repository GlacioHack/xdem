...
ddem.data[np.abs(ddem.data)>4*xdem.spstats.nmad(ddem.data)] = np.nan
...
df = xdem.spstats.sample_multirange_empirical_variogram(dh=ddem.data, gsd=ddem.res[0], nsamp=2000, nrun=100, maxlag=20000)
